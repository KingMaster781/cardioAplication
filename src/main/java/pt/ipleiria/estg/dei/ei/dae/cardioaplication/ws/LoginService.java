...
import pt.ipleiria.estg.dei.ei.dae.cardioaplication.dtos.AuthDTO;
import pt.ipleiria.estg.dei.ei.dae.cardioaplication.ejbs.JwtBean;
import pt.ipleiria.estg.dei.ei.dae.cardioaplication.ejbs.UserBean;
import pt.ipleiria.estg.dei.ei.dae.cardioaplication.entities.User;
import pt.ipleiria.estg.dei.ei.dae.cardioaplication.jwt.Jwt;
    ...
    public Response demonstrateClaims(@HeaderParam("Authorization") String auth) {
        if (auth != null && auth.startsWith("Bearer ")) {
            try {
                ...
                return Response.ok(j.getJWTClaimsSet().getClaims()).build(); } catch (ParseException e) {
